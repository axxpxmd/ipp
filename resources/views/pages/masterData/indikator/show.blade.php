        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul role="tablist" class="nav nav-material nav-material-white responsive-tab">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active show" id="tab1" data-toggle="tab" href="#semua-data" role="tab"><i class="icon icon-bookmark-o"></i>Indikator</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="tab-content my-3" id="pills-tabContent">
            <div class="tab-pane animated fadeInUpShort show active" id="semua-data" role="tabpanel">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <h6 class="card-header"><strong>Data Indikator</strong></h6>
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="row">
                                        <label class="col-md-2 text-right s-12"><strong>Indikator :</strong></label>
                                        <label class="col-md-10 s-12">{{ $indikator->n_indikator }}</label>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-2 text-right s-12"><strong>Deskripsi :</strong></label>
                                        <label class="col-md-10 s-12">{{ $indikator->deskripsi != null ? $indikator->deskripsi : '-' }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" id="form" method="PATCH"  enctype="multipart/form-data" novalidate>
                                    {{ method_field('PATCH') }}
                                    <input type="hidden" id="id" name="id" value="{{ $indikator->id }}"/>
                                    <div class="form-row form-inline">
                                        <div class="col-md-8">
                                            <div class="form-group mt-1">
                                                <label for="n_indikator" class="col-form-label s-12 col-md-2">Indikator<span class="text-danger ml-1">*</span></label>
                                                <textarea name="n_indikator" id="" cols="10" rows="5" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required>{{ $indikator->n_indikator }}</textarea>
                                            </div>
                                            <div class="form-group m-0">
                                                <label for="deskripsi" class="col-form-label s-12 col-md-2">Deskripsi<span class="text-danger ml-1">*</span></label>
                                                <textarea name="deskripsi" id="" cols="10" rows="5" class="form-control r-0 light s-12 col-md-8" autocomplete="off">{{ $indikator->deskripsi }}</textarea>
                                            </div>
