                            ...
                            <div class="form-row form-inline">
                                <div class="col-md-12">
                                    <div class="form-group mt-1">
                                        <label for="n_tempat" class="col-form-label s-12 col-md-4">Nama<span class="text-danger ml-1">*</span></label>
                                        <input type="text" name="n_tempat" id="n_tempat" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            $('#id').val(data.id);
            $('#n_tempat').val(data.n_tempat).focus();
